...
*/
    ...
    function loadImage(index, callback) {
        ...
        //处理oss
        if (imageSrc.indexOf("?x-oss-process") != -1) {
            var imageSrc = imageSrc.substring(0, imageSrc.indexOf("?"));
        }
        image.setAttribute('src', imageSrc);
        image.id='baguette-image';
        /* diy start*/
        image.setAttribute('onclick', 'document.getElementById("baguetteBox-overlay").style.display="none"');
        image.setAttribute('onerror', "this.src=base+'/assets/img/no-img.jpg'");
        /* diy end */
